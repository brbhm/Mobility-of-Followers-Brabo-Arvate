...
capture graph close
graph combine a2.gph b2.gph c2.gph, graphregion(color(white)) plotregion(color(white)) title("Figure B3 - Election Manipulation - 2004 Election", size(medium))  rows(3)
...
capture graph close
graph combine a3.gph b3.gph c3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure B4 - Election Manipulation - 2008 Election", size(medium))  rows(3)
...
capture graph close
graph combine a4.gph b4.gph c4.gph, graphregion(color(white)) plotregion(color(white)) title("Figure B5 - Election Manipulation - 2012 Election", size(medium))  rows(3)
...
capture graph close
graph combine a5.gph b5.gph c5.gph, graphregion(color(white)) plotregion(color(white)) title("Figure B6 - Election Manipulation - 2016 Election", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C3 - Election Manipulation - Male Candidate", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C4 - Election Manipulation - Candidate Education - College", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C5 - Election Manipulation - Candidate Education - High School", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C6 - Election Manipulation - Candidate Education - Elementary School", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C7 - Election Manipulation - Married Candidate", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C8 - Election Manipulation - Black Candidate (2016 election only)", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C9 - Election Manipulation - Brown Candidate (2016 election only)", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C10 - Election Manipulation - Yellow Candidate (2016 election only)", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C11 - Election Manipulation - Indigenous Candidate (2016 election only)", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C12 - Election Manipulation - White Candidate (2016 election only)", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C13 - Election Manipulation - Percentage of People in Rural Areas", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C14 - Election Manipulation - Percentage of Women", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C15 - Election Manipulation - Percentage of Women in Rural Areas", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C16 - Election Manipulation - GDP per capita", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C17 - Election Manipulation - Gini Index", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C18 - Election Manipulation - Bolsa Familia Beneficiaries", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C19 - Election Manipulation - Percentage of People with Access to Water", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C20 - Election Manipulation - Murders of People from 15 to 29 years old", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C21 - Election Manipulation - Murders", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C22 - Election Manipulation - Percentage of People in Poverty", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C23 - Election Manipulation - Child Mortality", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C24 - Election Manipulation - Percentage of Illiterates", size(medium))  rows(3)
...
graph save aa3.gph, replace 
graph combine aa1.gph aa2.gph aa3.gph, graphregion(color(white)) plotregion(color(white)) title("Figure C25 - Election Manipulation - Percentage of Elderly", size(medium))  rows(3)
graph save perc_idosos.gph, replace
capture graph close

capture erase aa1.gph
capture erase aa2.gph
capture erase aa3.gph 
